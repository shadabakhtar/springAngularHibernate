...
@Configuration
@PropertySource("classpath:/ojt/configuration.properties")
@EnableTransactionManagement
@ComponentScans(value = { @ComponentScan("com.newgen.ojt.dao"),
@ComponentScan("com.newgen.ojt.services")})
...
public class DBConfig {
	   ...
	   public LocalSessionFactoryBean getSessionFactory() {
		  ...
		  factoryBean.setPackagesToScan(new String[]{"com.newgen.ojt.beans"});
